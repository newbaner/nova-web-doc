...
!(function (t, e) {
	...
	var w = function (t) {
			return (
				"object" === n(t) && null !== t && t.constructor === Object && "[object Object]" === Object.prototype.toString.call(t)
			);
		},
		k = function t() {
									...
									e.addEventListener("click", function (e) {
										if ("page" in e.target.dataset) {
											...
											var i = parseInt(e.target.dataset.page, 10),
												n = t.carousel;
											i !== n.page &&
												(n.pages.length < 3 && n.option("infinite") ? n[0 == i ? "slidePrev" : "slideNext"]() : n.slideTo(i));
										}
									}),
									(this.$list = e),
				...
				s(n, [
					{
						...
						value: function () {
							(this.pages = []),
								...
								this.$track &&
									this.pages.length &&
									(this.$track.style.transform = "translate3d(".concat(-1 * this.pages[this.page].left, "px, 0px, 0) scale(1)")),
					...
					},
					{
						...
						value: function (t) {
							...
							return (
								(o = o + (parseFloat(a.marginLeft) || 0) + (parseFloat(a.marginRight) || 0)), t.dataset.isTestEl && t.remove(), o
							);
						},
					},
					{
								...
								if (
									...
									(n = e.match(
										...
										? ((t.src = "//maps.google."
												.concat(n[1], "/?ll=")
												.concat(
													(n[2] ? n[2] + "&z=" + Math.floor(n[3]) + (n[4] ? n[4].replace(/^\//, "&") : "") : n[4] + "").replace(
														/\?/,
														"&"
													),
													"&output="
										...
										if (t.$iframe.isReady)
											return (
												t.video &&
													t.video.autoplay &&
													(i =
														"youtube" == t.vendor ? { event: "command", func: "playVideo" } : { method: "play", value: "true" }),
	...
	var K = (function () {
		function t(e) {
			...
			for (
				var i = 0,
					n = ["onReady", "onClosing", "onDone", "onPageChange", "onCreateSlide", "onRemoveSlide", "onImageStatusChange"];
				i < n.length;
				i++
			) {
				var a = n[i];
	...
	var J = (function () {
		...
		it = (function () {
			function t(e) {
				...
				o(this, t), (this.fancybox = e), (this.$container = null), (this.state = "init");
				for (
					var n = 0, a = ["onInit", "onPrepare", "onDone", "onKeydown", "onClosing", "onChange", "onSettle", "onRefresh"];
					n < a.length;
					n++
				) {
					var s = a[n];
						...
						},
						{
							...
							value: function () {
								...
								e &&
									...
									this.id || ((this.id = this.options.id || ++nova), this.$container.setAttribute("id", "fancybox-" + this.id));
								var i,
