import{_ as n,c as i,a2 as a,o as p}from"./chunks/framework.BCQzPhDi.js";const g=JSON.parse('{"title":"项目结构","description":"","frontmatter":{},"headers":[],"relativePath":"admin/structure.md","filePath":"admin/structure.md","lastUpdated":1726653000000}'),l={name:"admin/structure.md"};function e(t,s,h,k,r,c){return p(),i("div",null,s[0]||(s[0]=[a(`<h1 id="项目结构" tabindex="-1">项目结构 <a class="header-anchor" href="#项目结构" aria-label="Permalink to &quot;项目结构&quot;">​</a></h1><p>一个 Admin 工程，默认包含如下目录及文件：</p><div class="language-yml vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">yml</span><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D;">├── nginx</span></span>
